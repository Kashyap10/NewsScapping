...
class alertlogic(object):
    ...
    def crawler_news(self):
        try:
            ...
            news_data = soup.find_all('div', class_='small-12 columns event-post-info')
                ...
                for news in news_data:
                    ...
                    news_dict.update(
                        {"title": title, "news_title_uid": hashlib.md5(title.encode()).hexdigest(),
                         ...
                         "company_id": "alertlogic", "topic_name": "press-releases", "ticker": "alertlogic_scrapped", "industry_name": "alertlogic",
                         "news_provider": "alertlogic"})
...
baseurl = "https://www.alertlogic.com/about-us/press-releases"
news_obj = alertlogic(baseurl, logger=logger)
...
isInserted, rowCount = Helper.processNews(news_collection, processed_collection, 'alertlogic')
print('Total rows added Process collection => ' + str(rowCount))

# UPDATING LOG COLLECTION
if (isInserted):
    Helper.makeLog(news_log_collection, processed_collection, 'alertlogic')
