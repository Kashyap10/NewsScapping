...
news_obj = canon(url,logger=logger)
...
isInserted,rowCount = Helper.processNews(news_collection,processed_collection,'canon')
print('Total rows added Process collection => ' + str(rowCount))

# UPDATING LOG COLLECTION
if (isInserted):
    Helper.makeLog(news_log_collection,processed_collection,'canon')