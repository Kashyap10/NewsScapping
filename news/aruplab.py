            ...
            while loop:
                ...
                if news_data:
                    for news in news_data:
                        ...
                        url = "https://www.aruplab.com"+str(url_data['href']) if url_data else ''
                        ...
                        publish_date_data = news.find('span',{'class':'views-field views-field-field-date'})
                        ...
                        description_data = url_soup.find('main',{'role':"main"}).find('div',{'class':'field field--name-body field--type-text-with-summary field--label-hidden field__item'})
                        ...
                        news_dict.update(
                            {"title": title, "news_title_uid": hashlib.md5(title.encode()).hexdigest(),
                             ...
                             "company_id": "aruplab", "ticker": "aruplab_scrapped", "industry_name": "aruplab",
                             "news_provider": "aruplab"})
...
url = "https://www.aruplab.com/news/press?page={page}"
news_obj = aruplab(url,logger=logger)
...
isInserted,rowCount = Helper.processNews(news_collection,processed_collection,'aruplab')
print('Total rows added Process collection => ' + str(rowCount))

# UPDATING LOG COLLECTION
if (isInserted):
    Helper.makeLog(news_log_collection,processed_collection,'aruplab')